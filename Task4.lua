...
function test()
	...
	info=infoTableOfPlatformSensors()
	leftSensor=info[1]
	--simExtPrintInfo(tostring(leftSensor.distance))
	mmpos=robot.simGetObjectPosition(leftSensor.ObjHandle,mmpos)
	simExtPrintInfo(tostring(mmpos[1])..' '..tostring(mmpos[2]))
